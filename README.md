...
当前版本为 `3.0.0-rc.13` 公开候选：今天页和底部导航进一步收紧，跑步卡改为“详情 + 单圆打卡”，完成后同一按钮变绿并锁定；跑步记录页保留公里数、用时、配速、心率和备注等完整信息。今天页仍按跑步、喝水、阅读、早睡、少刷手机和轻食等习惯类型提供个性化记录内容，长期目标推导每日安排、可选多阶段推进、进展月历、习惯归档，以及普通/加密备份、原子恢复和由用户控制的 PWA 安装、离线提示及安全更新流程继续保留。
