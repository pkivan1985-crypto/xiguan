...
当前版本为 `3.0.0-rc.8` 公开候选：手机端已收敛为“今天、进展、习惯”三个主要入口；进展月历支持为过去日期补记当天计划执行但遗漏的习惯，并修复补打卡操作区在手机上被月历卡片底边裁切的问题。直接打卡、记录实际进度与跑步详情、长期目标推导每日安排、可选多阶段推进、习惯归档，以及普通/加密备份、原子恢复和由用户控制的 PWA 安装、离线提示及安全更新流程继续保留。
