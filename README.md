...
当前版本为 `3.0.0-rc.17` 公开候选：新增“自媒体输出”习惯，可按图文、短视频、音频和直播记录同一天的多条作品，区分已发布与草稿，并在进展中查看月度类型分布、累计目标和最近作品。今天页的自媒体卡片使用一个完成勾，并提供“查看记录｜新增输出”两个明确入口。跑步、喝水、阅读、早睡、少刷手机、轻食和额外开支等既有习惯继续保留各自的记录内容；长期目标推导每日安排、可选多阶段推进、习惯归档，以及普通/加密备份、原子恢复和由用户控制的 PWA 安装、离线提示及安全更新流程保持不变。
