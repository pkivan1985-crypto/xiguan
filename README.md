...
当前版本为 `3.0.0-rc.10` 公开候选：今天页按习惯类型提供对应记录内容，跑步可填写公里数、时长、平均配速、平均心率和备注，轻食可逐项记录预设及自定义饮食约束；创建习惯同步扩充轻食等预设。今天页卡片支持左滑并经二次确认永久删除，历史、目标和关联数据沿用事务式清理。长期目标推导每日安排、可选多阶段推进、进展月历、习惯归档，以及普通/加密备份、原子恢复和由用户控制的 PWA 安装、离线提示及安全更新流程继续保留。
