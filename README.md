...
当前版本为 `3.0.0-rc.18` 公开候选：新增本地记账习惯，可记录同一天的多笔收入与支出，并填写日期、时间、分类、账户、事项和备注。今天页会显示今日支出、笔数与本月支出，有账才以绿色勾表示完成；独立账本支持新增和修改，统计页提供月份切换、月度结余、预算、分类占比、最近 7 天和最近账目。跑步、喝水、阅读、早睡、少刷手机、轻食、额外开支和自媒体输出等既有习惯继续保留各自的记录内容；普通/加密备份、原子恢复及 PWA 安全更新流程保持不变。
