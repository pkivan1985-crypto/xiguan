...
当前版本为 `3.0.0-rc.7` 公开候选：手机端已收敛为“今天、进展、习惯”三个主要入口；除直接打卡、记录实际进度与跑步详情外，进展月历现在支持为过去日期补记当天计划执行但遗漏的习惯，并保护未来日期、休息日和已有记录。长期目标推导每日安排、可选多阶段推进、习惯归档，以及普通/加密备份、原子恢复和由用户控制的 PWA 安装、离线提示及安全更新流程继续保留。
