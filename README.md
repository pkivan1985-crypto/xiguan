...
当前版本为 `3.0.0-rc.9` 公开候选：手机端已收敛为“今天、进展、习惯”三个主要入口；进展月历支持补记过去日期，并允许直接修改已保存的补打卡记录。跑步记录可补充、修正或清空实际公里数、时长、平均配速、平均心率和备注；修改仍会安全重算目标与成果月历，不会重复累计。长期目标推导每日安排、可选多阶段推进、习惯归档，以及普通/加密备份、原子恢复和由用户控制的 PWA 安装、离线提示及安全更新流程继续保留。
