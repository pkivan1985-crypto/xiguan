...
function HomeDashboardContent({ model, todayLocalDate, onPreviousMonth, onNextMonth, canGoNext }: HomeDashboardContentProps) {
	...
	return <div className={styles.page}>
		...
		<nav className={`${styles.actionRow} ${model.hasCards ? styles.pairedActions : ''}`} aria-label={t('shell.home.quickActions')}>
			...
			{model.hasCards && <Link className={styles.secondaryAction} to={APP_ROUTES.DECK_NEW}>
				<span className={styles.secondaryIcon}><FiPlus aria-hidden='true' /></span><span className={styles.secondaryLabel}>{t('shell.createCard.create')}</span>
			</Link>}
		</nav>
